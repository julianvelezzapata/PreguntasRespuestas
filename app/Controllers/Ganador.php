...
class Ganador extends BaseController
{
    ...
    public function registrar(){
          ...
          return redirect()->to(site_url('/formulario/ganador'))->with('mensaje', $mensaje);
        }
    ...
    try {                       // intente hacer esto  
        ...
        return redirect()->to(site_url('/formulario/ganador'))->with('mensaje', "exito agregando productos");
